    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('Admin', 'Administrateur'), ('Manager', 'Manager de Projet'), ('Comptable', 'Comptable'), ('Chef_Chantier', 'Chef de Chantier'), ('Lecteur', 'Lecteur')], default='Lecteur', max_length=20, verbose_name='Rôle')),
